/* Amplify Params - DO NOT EDIT
	API_MOTIVATIONALQUOTEGEN_GRAPHQLAPIIDOUTPUT
	API_MOTIVATIONALQUOTEGEN_QUOTEAPPDATATABLE_ARN
	API_MOTIVATIONALQUOTEGEN_QUOTEAPPDATATABLE_NAME
	ENV
	REGION
Amplify Params - DO NOT EDIT */
...
//Funcation: update DynamoDB table
async function updateQuoteDDBObject() {
    const quoteTableName = process.env.API_MOTIVATIONALQUOTEGEN_QUOTEAPPDATATABLE_NAME;
...
exports.handler = async (event) => {
    ...
    async function getRandomQuote(apiURLinput) {
        ...
        //Update DynamoDB objects in table
        try {
